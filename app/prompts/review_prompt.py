...
TASK_PROMPT_FRENCH = (
    ...
    "Follow every step listed in Phase 1, Phase 2, Phase 3 and Phase 5 of your instructions (exclude Phase 4), "
...
def get_fixed_mode_instructions(prompt_mode: Optional[str]) -> str:
    ...
    return _INSTRUCTIONS_COMPARISON if mode == "comparison" else _INSTRUCTIONS_FRENCH_REVIEW
...
def build_review_prompt(
    ...
    task_prompt = TASK_PROMPT_COMPARISON if comparison_mode else TASK_PROMPT_FRENCH
